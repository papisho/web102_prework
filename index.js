...
function filterUnfundedOnly() {
    ...
    const unfundedGames = GAMES_JSON.filter(function(game) {
...
function filterFundedOnly() {
    ...
    const fundedGames = GAMES_JSON.filter(function(game) {
        return game.pledged >= game.goal;
    });
...
// a) Get an array of unfunded games
const unfundedGames = GAMES_JSON.filter(function(game) {
    return game.pledged < game.goal;
  });
...
messageP.innerHTML = displayStr;
// append the message under the description container
descriptionContainer.appendChild(messageP);
